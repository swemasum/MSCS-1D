         ...
         <div class="col-md-12">
           ...
           <div class="box box-primary">
             <div class="box-header with-border">
               <h3 class="box-title">New simulator</h3>
             </div>
             <!-- /.box-header -->
             <!-- form start -->
             <form role="form" action="add_simulator_done.php" method="post" enctype="multipart/form-data">
               <div class="box-body">
                 <div class="row">
                   <div class="col-md-12">
                ...
                <label for="exampleInputEmail1">simulator File/manual(image/pdf/word File)<span style="color:red">(UP TO 2 MB)</span> </label>
                <div class="input-group image-preview">
                ...
                <span class="input-group-btn">
                   ...
                   <div class="btn btn-default image-preview-input">
                       ...
                       <input type="file" accept="image/png, image/jpeg, image/gif,application/msword,application/pdf" name="file" id="image"/> <!-- rename it -->
                   </div>
                </span>
