  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pages/layout/active_user.php">
            <i class="	glyphicon glyphicon-user"></i> <span >Active user</span>

          </a>
        </li>
        <li>
          <a href="pages/layout/requested_user.php">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              include_once "../connection.php";
               $sql = "SELECT COUNT(request_id) as user FROM request where status='pending'";
        ...
        <!-- ./col -->
        <?php
         $sql = "SELECT COUNT(request_id) as active FROM request where status='active'";
          $result = mysqli_query($conn, $sql);
