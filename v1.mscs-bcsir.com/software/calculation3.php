...
<html lang="en">
    <head>
        ...
        <script src="script/junction_3_cal.js"></script>
  ...
  function exportToExcel(tableID){
      ...
      return (sa);
            ...
            <table>
                <tr>
                    ...
                    LINE CHART </h2>
                                    ...
                                    <div class="modal-footer">
									<button type="button" class="btn btn-primary" onclick="download_all()"><a  id="link4" download="ChartPng.png">Save as png</a></button>
                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                    </div>
                                </div>
                            </div>
            ...
            <table>
                <tr>
                    ...
                    LINE CHART </h2>
                                    ...
                                    <div class="modal-footer">
									<button type="button" class="btn btn-primary" onclick="download_sunvseff()"><a  id="link5" download="ChartPng.png">Save as png</a></button>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-10 col-sx-10 span10" style="border: 2px solid #4286f4;">
                    <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-sx-3 ">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="formInput128">M
                                <sub style="font-weight:bold;font-size:20px">v</sub>&nbsp;(No of equivalent minima in the valence band)
                            </label>
              ...
              options: {
                 ...
                 scales: {
                   ...
                   xAxes: [{
					...
					function setall(dataset1,dataset2,dataset3,xaxis){
