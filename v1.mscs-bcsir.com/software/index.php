              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="container-fluid">
					...
					<a class="btn btn-info" type="button" href="calculation2.php">TWO</a>&nbsp
...
<!-- select number of junction end-->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top" >Simulator</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in" style="margin-bottom:0px"> <p style=" font-size: 30px;margin:0;padding-bottom:0">One dimensional multijunction solar cell simulator: Version - 1</p></div>
          <div class="intro-heading text-uppercase" style=" font-size: 40px;margin-bottom:0px"><p>MSCS-1d : v1</p></div>
