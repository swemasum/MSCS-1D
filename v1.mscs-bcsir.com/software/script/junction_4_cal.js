...
function calall(){
	...
	if(xaxis.length>xaxis2.length && xaxis.length>xaxis3.length && xaxis.length>xaxis4.length){
		big=xaxis;
	}else if(xaxis2.length>xaxis.length && xaxis2.length>xaxis3.length && xaxis2.length>xaxis4.length){
		big=xaxis2;
	}else if(xaxis3.length>xaxis.length && xaxis3.length>xaxis2.length && xaxis3.length > xaxis4.length){
		big=xaxis3;
	}else{
		big=xaxis4;
	}
	...
	console.log(big);
	setall(plotData,plotData2,plotData3,plotData4,big);
					 ...
					 var mc6 = document.getElementById("mc4").value;
						...
						for(var G=sun_min;G<=sun_max;G++){
							console.log("step::::"+G);
								...
								//var jsc2_sun_eff=e*F;
								console.log("jsc2_sun_eff::"+jsc2_sun_eff);
								...
								console.log("jsc3_sun_eff::"+jsc3_sun_eff);
								...
								//var jsc1_sun_eff=e*F;
								console.log("jsc4_sun_eff::"+jsc4_sun_eff);
							    ...
							    var voc4_sun_eff=k*t*Math.log((jsc4_sun_eff/j04)+1)/e;
									...
									console.log("jsc4_sun_eff:"+jsc4_sun_eff);
									console.log("voc44:"+voc4_sun_eff);

								console.log("jsc1_sun_eff:::"+jsc1_sun_eff);
								console.log("jsc2_sun_eff:::"+jsc2_sun_eff);
								console.log("jsc3_sun_eff:::"+jsc3_sun_eff);
								array_jsc[0]=jsc1_sun_eff;
								array_jsc[1]=jsc2_sun_eff;
								array_jsc[2]=jsc3_sun_eff;
								array_jsc[3]=jsc4_sun_eff;
								min_jsc=Math.min(...array_jsc);
								voc_sun_eff=voc1_sun_eff+voc2_sun_eff+voc3_sun_eff+voc4_sun_eff;
								console.log("min_jsc::::::::"+min_jsc);
