<?php
//installbg
//$rifilename='/home/shohmnko/mscs-bcsir.com/vendor/fontawesome-free/LICENSEs.txt';
//require("$rifilename");
//installend
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">MSCS-1D:V2</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="https://scs-bcsir.org/">Go to main website
            </a>
          </li>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold" >MSCS-1d:V2</h1>
          <hr class="divider my-4">
        </div>
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">One dimensional multijunction solar cell simulator: Version-2</p>
...
return confirm("Dear "+name+". We will send a password (for version-2) through this email  '"+email+"'. Are you sure email is correct?");
  ...
  <section class="page-section bg-primary" id="about">
      ...
      <div class=" row">
        <div class="col-md-6" style="border-right:1px solid black">
          <div class="row justify-content-center">
            ...
            <!--  <h2 class="text-white mt-0">This version is totally free!</h2> -->
              <h4 class="text-white mt-0">Create an account!</h4>
              <hr class="divider light my-4">
           <?php
          if(isset($_SESSION['requested'])){
          ECHO '  <p class="text-white mb-4">Thank you for your request! Check your mail for MSCS-1D password. (It may takes some time upto 1 minute!)</p>';
          }else{
        ...
        <div class="col-md-6" style="border-left:1px solid black">
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
            <h4 class="text-white mt-0">Sign in!</h4>
              <hr class="divider light my-4">
              <?php
          ...
          <input type="password" name="pin" class="form-control" id="email">
          </div>
...
About MSCS-1D
                 ...
                 <p class="section-subheading card-text mb-auto" style="line-height: 1.6; font-style: italic;text-align:justify ">

                     One dimensional multijunction solar cell simulator: Version-1 (MSCS-1D: V-1) is developed by Advanced Photovoltaic Lab, Bangladesh Council of Scientific and Industrial Research (BCSIR).This work is financially supported by the Ministry of Science and Technology, the People’s Republic of Bangladesh under Special Allocation Project. Mr. Abu Kowsar is the principal investigator of this project, Dr. Syed Farid Uddin Farhad and Khaledun Nahar Babi are the co-investigator of this project.
                     Syed Nazmus Sakib, Lecturer, Department  of ETE, Daffodil International University contributed here as a M.S.  thesis student  of Institute of Energy, University of Dhaka.
                     The user friendly interface and the dialogue box of this simulation software were accomplished by the assitance of Mr. Md. Masum Billah, Mr. Sujoy Dey and Sazzatul Yeakin, SoftCare IT.</p>
...
Abu Kowsar <br>
Scientific Officer & Principal Investigator <br>
Advanced Photovoltaic Lab, <br>
PID, BCSIR Laboratories Dhaka <br>
...
Dhanmondi, Dhaka-1205, Bangladesh <br>
  ...
  <!--    <div class="row">
   <div class="col-lg-4 "> -->
      ...
      <!--  </div> 
       ...
       <!--   <a class="d-block" href="mailto:mscsbcsir@gmail.com">mscsbcsir@gmail.com</a>
        </div> 
      </div>
    </div>
  </section> -->
  ...
  <footer class="bg-light py-5">
    <div class="container">
      ...
      Copyright &copy; All rights reserve to Bangladesh Council of Scientific and Industrial Research (BCSIR),2020.
</div>
    </div>
  </footer>
