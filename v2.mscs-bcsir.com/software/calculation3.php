...
<option value="AlAs">AlAs</option>
                                      ...
                                      <div class="btn-group" style="margin-bottom:5px">
                                          ...
                                          <ul class="dropdown-menu" role="menu">
                                              <li>
                                                  <a href="#" class="btn btn-success" style="color:white;background:green" onclick="calall()" data-target="#exampleModalall" data-toggle="modal">voc vs jsc</a>
                                              </li>
